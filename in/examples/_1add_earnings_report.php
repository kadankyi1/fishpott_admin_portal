...
$page_name = "Add Earnings Report For A Business"; 
$page_name_real = "shares_management"; 
...
$query =  "SELECT " . SHARES_HOSTED_TABLE_NAME . ".share_name,  "  . SHARES_HOSTED_TABLE_NAME . ".parent_shares_id,  " . SHARES_HOSTED_TABLE_NAME . ".yield_per_share,  "  . SHARES_HOSTED_TABLE_NAME . ".value_per_share  FROM "  . SHARES_HOSTED_TABLE_NAME; 
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add Earnings Report</h4>
                  <?php if(isset($_SESSION["asem"]) && trim($_SESSION["asem"]) != "") { ?>
                  <p class="card-category"><?php echo $_SESSION["asem"]; unset($_SESSION["asem"]); ?></p>
                  <?php } else { ?>
                  <p class="card-category">Based on the latest valuation of a hosted business', update earnings for the public</p>
                  <?php } ?>
                </div>
                <div class="card-body">
                  <form method="POST" action="../../../inc/admin/update_shares_value.php">
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    $prepared_statement_results_array = $preparedStatementObject->getPreparedStatementQueryResults($prepared_statement, array("share_name", "parent_shares_id", "yield_per_share", "value_per_share"), 4, 2);

                    //BINDING THE RESULTS TO VARIABLES
                    $prepared_statement_results_array->bind_result($share_name, $parent_shares_id, $yield_per_share, $value_per_share);

                    while($prepared_statement_results_array->fetch()){
                    ?>
                      <option value="<?php echo $parent_shares_id ?>"><?php echo $share_name; ?> ($<?php echo $value_per_share; ?> Value Per Share || $<?php echo $yield_per_share; ?> Dividend Per Share)</option>
                    <?php 
                    }
                    ?>
                          </select> 
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">New Dividend Per Share In Dollars</label>
                          <input type="number" step="0.01" min="0" name="share_dividend" class="form-control">
                        </div>
                      </div>
