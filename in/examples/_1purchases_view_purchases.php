...
$page_name = "Purchases"; 
$page_name_real = "current_purchases"; 
...
$query =  "SELECT " 
          ...
          . PURCHASES_TABLE_NAME . ".price_per_item_num,  " 
          . PURCHASES_TABLE_NAME . ".transaction_currency,  " 
          . PURCHASES_TABLE_NAME . ".sale_real_amt_credited_to_seller_acc,  " 
          . PURCHASES_TABLE_NAME . ".buyer_old_withdrawal_wallet_usd,  " 
          . PURCHASES_TABLE_NAME . ".buyer_old_debit_wallet_usd,  " 
          . PURCHASES_TABLE_NAME . ".fp_commission,  " 
          . SHARES_TRANSFER_TABLE_NAME . ".admin_id,  " 
          . PURCHASES_TABLE_NAME . ".processing_fee_num,  " 
          . PURCHASES_TABLE_NAME . ".insurance_fee,  " 
          . PURCHASES_TABLE_NAME . ".received_item_id FROM "  
...
$order_by_addition = " ORDER BY " . PURCHASES_TABLE_NAME . ".sku ASC LIMIT  " . $page_results_quantity;
...
if(isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST" && !isset($_GET["o"])){
  ...
  $where_clause_sql_query_addition = " WHERE  " . SHARES_TRANSFER_TABLE_NAME . ".transfer_type = 'sale' AND " . PURCHASES_TABLE_NAME . ".adetor_pay_type = 'FP WALLET'";
    ...
    if(isset($_POST["admin_review_status"]) && trim($_POST["admin_review_status"]) != "" && trim($_POST["admin_review_status"]) != "2"){
    	if(trim($_POST["user_age_start"]) == "all"){
            $_SESSION["current_purchases_where_clause_set_passive"] = true;
        } else {
    ...
    $_SESSION["current_purchases_order_by_clause"] = $order_by_addition;
    $_SESSION["current_purchases_value_holder_array"] = $value_holder_array;
    $_SESSION["current_purchases_value_types_string"] = $value_types_string;
    $query .= $where_clause_sql_query_addition . $order_by_addition;

    $_SESSION["current_purchases_where_clause"] = $where_clause_sql_query_addition . " AND " . PURCHASES_TABLE_NAME . ".sku > ? ";
} else if(
	!isset($_GET["o"]) &&
	(
		(isset($_SESSION["current_purchases_where_clause_set_passive"]) && $_SESSION["current_purchases_where_clause_set_passive"]=== true) ||
		(isset($_SESSION["current_purchases_where_clause"]) && trim($_SESSION["current_purchases_where_clause"]) != "")
	)
	
){
    $value_holder_array = $_SESSION["current_purchases_value_holder_array"];
    $value_types_string = $_SESSION["current_purchases_value_types_string"];
    ...
    $query .= $_SESSION["current_purchases_where_clause"] . $where_clause_sql_query_addition . $_SESSION["current_purchases_order_by_clause"];
}  else {
  ...
  if(isset($_GET["start_sku"]) && intval($_GET["start_sku"]) > 0){
    ...
    $where_clause_sql_query_addition =   " WHERE " . SHARES_TRANSFER_TABLE_NAME . ".transfer_type = 'sale' AND " . SHARES_TRANSFER_TABLE_NAME . ".admin_review_status  = 0 AND " . PURCHASES_TABLE_NAME . ".adetor_pay_type = 'FP WALLET'  AND " . PURCHASES_TABLE_NAME . ".sku > ? ";
    ...
    $_SESSION["current_purchases_where_clause"] = $where_clause_sql_query_addition;
    $_SESSION["current_purchases_order_by_clause"] = $order_by_addition;

  } else {
	
	$where_clause_sql_query_addition = " WHERE  " . SHARES_TRANSFER_TABLE_NAME . ".transfer_type = 'sale' AND " . SHARES_TRANSFER_TABLE_NAME . ".admin_review_status  = 0 AND " . PURCHASES_TABLE_NAME . ".adetor_pay_type = 'FP WALLET'";
  }
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Search Shares Purchases</h4>
                  <?php if(isset($_SESSION["asem"]) && trim($_SESSION["asem"]) != "") { ?>
                  <p class="card-category"><?php echo $_SESSION["asem"]; unset($_SESSION["asem"]); ?></p>
                  <?php } else { ?>
                  <p class="card-category">Find shares purchase transactions based on the criteria you want</p>
                  <?php } ?>
                </div>
                <div class="card-body">
                  <form method="POST" action="_1purchases_view_purchases.php">
                    <div class="row">
                      <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <label class="bmd-label-floating">Buyer/Seller Pott name</label>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Share Purchases Transactions Table</h4>
                  <p class="card-category">Make sure you are completely sure the purchase is legit before confirming it.</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <thead class=" text-primary">
                        ...
                        <th style="color: #1f1f14; font-weight: bolder;">
                          Insurance<br>- - - -<br>Process Fee
                        </th>
                        <th style="color: #1f1f14; font-weight: bolder;">
                          Seller<br>- - - -<br>Buyer
                        </th>
                        <th style="color: #1f1f14; font-weight: bolder;">
                          Sold Share ID<br>- - - -<br>Received Share ID
                        </th>
                        <th style="color: #1f1f14; font-weight: bolder;">
                           Shares<br>- - - -<br>S-Date
                        </th>
                        <th style="color: #1f1f14; font-weight: bolder;">
                          Debwallet<br>- - - -<br>Widwallet
                        </th>
                        <th style="color: #1f1f14; font-weight: bolder;">
                          Seller Pay<br>- - - -<br>FP Pay                         
                        </th>
                        <th style="color: #1f1f14; font-weight: bolder;">
                          No.
                        </th>
                    ...
                    $prepared_statement_results_array = $preparedStatementObject->getPreparedStatementQueryResults($prepared_statement, array("profile_picture", "pot_name", "first_name", "last_name", "country", "phone", "investor_id", "verified_tag", "login_type", "flag", "sku", "receiver_id", "share_id", "item_quantity", "admin_review_status", "shares_parent_name", "start_date", "sender_old_quantity", "sku", "total_charge_num", "price_per_item_num", "transaction_currency", "sale_real_amt_credited_to_seller_acc", "buyer_old_withdrawal_wallet_usd", "buyer_old_debit_wallet_usd", "fp_commission", "admin_id", "processing_fee_num", "insurance_fee", "received_item_id"), 30, 2);

                    //BINDING THE RESULTS TO VARIABLES
                    $prepared_statement_results_array->bind_result($profile_picture, $pot_name, $first_name, $last_name, $country, $phone, $investor_id, $verified_tag, $login_type, $flag, $transfer_sku, $receiver_id, $share_id, $num_shares_transfered, $admin_review_status, $shares_parent_name, $start_date, $sender_old_quantity, $sku, $total_charge_num, $price_per_item_num, $transaction_currency, $sale_real_amt_credited_to_seller_acc, $buyer_old_withdrawal_wallet_usd, $buyer_old_debit_wallet_usd, $fp_commission, $admin_id, $processing_fee_num, $insurance_fee, $received_item_id);
                    ...
                    ?>
                        <tr>
                          ...
                          <td>
                          <?php echo $transaction_currency . " " . $price_per_item_num ; ?>
                          <br>- - - -<br>
                          <?php echo $transaction_currency . " " . $total_charge_num ; ?>
                          </td>
                          <td>
                          <?php echo $transaction_currency . " " . $insurance_fee ; ?>
                          <br>- - - -<br>
                          <?php echo $transaction_currency . " " . $processing_fee_num ; ?>
                          </td>
                          <td>
                          ...
                          <td>
                            <span class="text-primary">
                              <?php echo $share_id; ?>
                                <br>- - - -<br>
                              <?php echo $received_item_id; ?>
                              </span>
                          </td>
                          <td>
                          <?php echo $shares_parent_name; ?>
                          <br>- - - - -<br>
                          <?php echo $start_date; ?>
                          </td>
                          <td>
                          <?php echo $buyer_old_debit_wallet_usd; ?>
                          <br>- - - -<br>
                          <?php echo $buyer_old_withdrawal_wallet_usd; ?>
                          </td>
                          <td class="text-primary">
                            <?php echo $transaction_currency . " " . $sale_real_amt_credited_to_seller_acc; ?>
                          <br>- - - -<br>
                            <?php echo $transaction_currency . " " . $fp_commission; ?>
                          </td>
                          <td class="text-primary">
                          ...
                          <td>
                            ...
                            <a href="../../../inc/admin/purchases_take_action.php?i=<?php echo $sku; ?>&i2=<?php echo $transfer_sku; ?>&t=1">
                                <img class="material-icons" src="../img/correct.png" alt="complete" style="width: 20px; height: 20px;">
                            </a>
                            <a href="../../../inc/admin/purchases_take_action.php?i=<?php echo $sku; ?>&i2=<?php echo $transfer_sku; ?>&t=0">
                    ...
                    $next_page_link = "_1purchases_view_purchases.php?start_sku=" . $sku;
                    $previous_page_link = "_1purchases_view_purchases.php?start_sku=" . $first_sku;
                    ?>
