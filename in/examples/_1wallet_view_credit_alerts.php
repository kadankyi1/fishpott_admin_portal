...
$page_name = "Wallet Credit Requests"; 
$page_name_real = "credit_requests"; 
...
$query =  "SELECT " 
          ...
          . MONEY_CREDIT_TABLE_NAME . ".reviewer_admin_id,  " 
          ...
          . MONEY_CREDIT_TABLE_NAME . ".sender_name,  " 
          . MONEY_CREDIT_TABLE_NAME . ".send_date,  " 
          . MONEY_CREDIT_TABLE_NAME . ".input_date FROM "  
          . MONEY_CREDIT_TABLE_NAME . " INNER JOIN " 
...
if(isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST" && !isset($_GET["o"]) ){
    ...
    if(isset($_POST["user_age_start"]) && trim($_POST["user_age_start"]) != ""){
        if(trim($_POST["user_age_start"]) == "all"){
            $_SESSION["credit_requests_where_clause_set_passive"] = true;
        } else {
            ...
            $where_clause_sql_query_addition .= " $or_where_and_statements " . MONEY_CREDIT_TABLE_NAME . ".done_status = ? ";
    ...
    if(isset($_POST["transaction_id"]) && trim($_POST["transaction_id"]) != ""){
        ...
        $where_clause_sql_query_addition .= " $or_where_and_statements " . MONEY_CREDIT_TABLE_NAME . ".transaction_id = ? ";
        array_push($value_holder_array, $transaction_id);
        $value_types_string .= "s";
    }
	...
	$where_clause_sql_query_addition .= " $or_where_and_statements " . MONEY_CREDIT_TABLE_NAME . ".sku > ? ";

    $_SESSION["credit_requests_where_clause"] = $where_clause_sql_query_addition;
    $_SESSION["credit_requests_order_by_clause"] = $order_by_addition;
    $_SESSION["credit_requests_value_holder_array"] = $value_holder_array;
    $_SESSION["credit_requests_value_types_string"] = $value_types_string;

} else if(
    !isset($_GET["o"]) && 
    (

        (isset($_SESSION["credit_requests_where_clause_set_passive"]) && $_SESSION["credit_requests_where_clause_set_passive"]=== true) || 
        (isset($_SESSION["credit_requests_where_clause"]) && trim($_SESSION["credit_requests_where_clause"]) != "")
    )
){
    $value_holder_array = $_SESSION["credit_requests_value_holder_array"];
    $value_types_string = $_SESSION["credit_requests_value_types_string"];
    ...
    $query .= $_SESSION["credit_requests_where_clause"] . $_SESSION["credit_requests_order_by_clause"];
  ...
  if(isset($_GET["start_sku"]) && intval($_GET["start_sku"]) > 0){
    ...
    $where_clause_sql_query_addition =    " WHERE " . MONEY_CREDIT_TABLE_NAME . ".done_status = 'pending' AND " . MONEY_CREDIT_TABLE_NAME . ".reviewer_admin_id = '' AND  " . MONEY_CREDIT_TABLE_NAME . ".sku > ? ";
    ...
    $_SESSION["credit_requests_order_by_clause"] = $order_by_addition;
        ...
        $where_clause_sql_query_addition =   " WHERE " . MONEY_CREDIT_TABLE_NAME . ".done_status = 'pending' AND " . MONEY_CREDIT_TABLE_NAME . ".reviewer_admin_id = ''";
    }
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Search Credit Transactions</h4>
                  <?php if(isset($_SESSION["asem"]) && trim($_SESSION["asem"]) != "") { ?>
                  <p class="card-category"><?php echo $_SESSION["asem"]; unset($_SESSION["asem"]); ?></p>
                  <?php } else { ?>
                  <p class="card-category">Find a credit transaction  by setting the criteria you need</p>
                  <?php } ?>
                </div>
                <div class="card-body">
                  <form method="POST" action="_1wallet_view_credit_alerts.php">
                    <div class="row">
                      <div class="col-md-2">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Credit Transactions Table</h4>
                  <p class="card-category">Make sure you have seen the money in the company's mobile money/bank account before completing a request. If the money is not there, cancel the request.</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo $withdrawal_wallet_usd; ?>
                          </td>
                          <td>
                           <span class="text-primary"><?php echo $pay_type; ?></span>
                          </td>
                          <td>
                            <span class="text-primary"><?php echo $sender_name; ?></span>
                          </td>
                          <td class="text-primary">
                            <?php echo $currency_sent . $amount_sent; ?>
                          </td>
                          <td class="text-primary">
                            <span class="text-primary"><?php echo $transaction_id; ?></span>
                          </td>
                          <td class="text-primary">
                            <?php echo $country; ?>
                          </td>
                          ...
                          <td>
                            <?php if($done_status == "pending" && $reviewer_admin_id == "") { ?>
                            <a href="../../../inc/admin/credit_request_take_action.php?i=<?php echo $sku; ?>&t=1">
                                <img class="material-icons" src="../img/correct.png" alt="complete" style="width: 20px; height: 20px;">
                            </a>
                            <a href="../../../inc/admin/credit_request_take_action.php?i=<?php echo $sku; ?>&t=0">
                    ...
                    $next_page_link = "_1wallet_view_credit_alerts.php?start_sku=" . $sku;
                    $previous_page_link = "_1wallet_view_credit_alerts.php?start_sku=" . $first_sku;
                    ?>
