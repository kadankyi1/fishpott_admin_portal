...
if(  trim($_SESSION["admin_pass"]) == "" || trim($_SESSION["admin_id"]) == "" || trim($_SESSION["admin_name"]) == "" 
	 ...
	 || trim($_SESSION["admin_profile_pic"]) == ""){
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header" style="margin-top: 5px; text-align: left;">
                <a href="index.html" style="color: black; font-weight: bolder; font-size: 17px; "><img class="main-logo" src="img/logo/logo.png" alt="" /> FishPott</a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a title="Landing Page" href="index.php" aria-expanded="false"><img src="img/dashboard.png" style="padding-bottom: 10px; height: 42px;">  <span class="mini-click-non">Dashboard</span></a>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><img src="img/customer-support.png" style="padding-bottom: 10px; height: 42px;"> <span class="mini-click-non">Customer Care</span></a>
                        ...
                        <!--
                         ...
                         -->
                        <li>
                            <a class="has-arrow" href="all-students.html" aria-expanded="false"><img src="img/users.png" style="padding-bottom: 10px; height: 42px;"> <span class="mini-click-non">Users</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="users_viewall.php"><span class="mini-sub-pro">View Users</span></a></li>
                                <li><a title="Add Students" href="add-student.html"><span class="mini-sub-pro">Add User</span></a></li>
                                <li><a title="Edit Students" href="edit-student.html"><span class="mini-sub-pro">Delete User</span></a></li>
                                <li><a title="Students Profile" href="users_view_single_user_profile.php"><span class="mini-sub-pro">View User Profile</span></a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="has-arrow" href="all-professors.html" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Admins</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="all-professors.html"><span class="mini-sub-pro">All Admins</span></a></li>
                                <li><a title="Add Professor" href="add-professor.html"><span class="mini-sub-pro">Add Admin</span></a></li>
                                <li><a title="Edit Professor" href="edit-professor.php"><span class="mini-sub-pro">Edit Admin</span></a></li>
                                <li><a title="Professor Profile" href="professor-profile.html"><span class="mini-sub-pro">Delete Profile</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="header-advance-area">
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="<?php echo $_SESSION['admin_profile_pic']; ?>" alt="" />
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="../../inc/admin/logout.php"><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
            ...
            <!-- Mobile Menu start
                        ...
                        <li>
                            <a class="has-arrow" href="all-students.html" aria-expanded="false"><img src="img/users.png" style="padding-bottom: 10px; height: 42px;"> <span class="mini-click-non">Users</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="all-students.html"><span class="mini-sub-pro">View Users</span></a></li>
                                <li><a title="Add Students" href="add-student.html"><span class="mini-sub-pro">Add User</span></a></li>
                                <li><a title="Edit Students" href="edit-student.html"><span class="mini-sub-pro">Delete User</span></a></li>
                                <li><a title="Students Profile" href="users_view_single_user_profile.phpl"><span class="mini-sub-pro">View User Profile</span></a></li>
                            </ul>
                        </li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demopro" href="#">Users</a>
                                            <ul id="demopro" class="collapse dropdown-header-top">
                                                <li><a href="users_viewall.php">View Users</a>
                                                </li>
                                                <li><a href="add-student.html">Add User</a>
                                                </li>
                                                <li><a href="edit-student.html">Delete User</a>
                                                </li>
                                                <li><a href="users_view_single_user_profile.php">View User Profile</a>
                                                </li>
                                            </ul>
                                        </li>
